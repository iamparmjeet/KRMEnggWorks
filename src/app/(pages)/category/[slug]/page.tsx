...
const categoryData = {
  'bar-cutting-machine': {
    ...
    products: [
      { id: 1, name: 'Bar Cutting Machine Model-GQ 40', price: 64000, image: '🏗️' },
      { id: 2, name: 'Bar Cutting Machine Model-GQ 52', price: 64000, image: '🏗️' },
      { id: 3, name: 'Bar Cutting Machine Model-GQ 30', price: 54000, image: '🏗️' },
      { id: 4, name: 'Bar Cutting Machine Model-GQ 60', price: 74000, image: '🏗️' },
      { id: 5, name: 'Bar Cutting Machine Model-GQ 75', price: 84000, image: '🏗️' },
      { id: 6, name: 'Bar Cutting Machine Model-GQ 90', price: 94000, image: '🏗️' },
    ],
  },
  'concrete-mixers': {
    ...
    description: 'Explore All Our Products Range',
    products: [
      { id: 7, name: 'Concrete Mixer Model 200L', price: 45000, image: '🏗️' },
      { id: 8, name: 'Concrete Mixer Model 300L', price: 55000, image: '🏗️' },
      { id: 9, name: 'Concrete Mixer Model 500L', price: 75000, image: '🏗️' },
    ],
  },
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6 items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-slate-600 text-sm">
              <span>Showing {filteredProducts.length} of {category.products.length} results</span>
            </div>
            ...
            <div className="lg:col-span-1 bg-white">
              ...
              <div className="space-y-2 text-sm">
                {allCategories.map((cat, idx) => (
                  <Link key={idx} href="#" className="text-blue-600 hover:underline block py-1">
                    • {cat}
                  </Link>
                ))}
              </div>
