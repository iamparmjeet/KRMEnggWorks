    ...
    <div className="w-full min-h-screen bg-background">
      ...
      <section className="bg-muted border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <p className="text-foreground/70">{cartItems.length} items in cart</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {cartItems.length > 0 ? (
                  ...
                  <Card key={item.id}>
                    <CardContent className="p-6">
                      <div className="flex gap-6">
                        <div className={`${item.image} w-32 h-32 rounded-lg flex-shrink-0 flex items-center justify-center text-white/20`}>
                          Image
                        </div>
                        <div className="flex-1">
                          ...
                          <p className="text-foreground/70 mt-2">${item.price.toLocaleString()}</p>
                    ...
                    <div className="space-y-3 border-b border-border pb-4">
                      ...
                      <div className="flex justify-between">
                        <span className="text-foreground/70">
                          Shipping {shipping === 0 && <span className="text-green-600 text-xs">(Free)</span>}
                        </span>
                  ...
                  <Card className="mt-4 bg-blue-50 border-blue-200">
                    <CardContent className="p-4">
                      <p className="text-sm text-blue-900">
                        Free shipping on orders over $5,000! Add ${(5000 - subtotal).toLocaleString()} more to qualify.
                      </p>
                    </CardContent>
                  </Card>
                )}
            ...
            <div className="text-center py-16">
              <ShoppingCart className="w-16 h-16 mx-auto text-foreground/20 mb-4" />
